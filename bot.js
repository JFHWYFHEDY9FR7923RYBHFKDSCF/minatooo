...
if (message.content.startsWith(prefix + 'help')) {
    ...
    💠 -skin => Ur Minecraft skin
    ===========================================================

	Soon And I Will Translate The Command o Englih`]
	let page = 1;
...
client.on('guildCreate', guild => {
  var embed = new Discord.RichEmbed()
  .setColor(0x5500ff)
  .setDescription(`**Thank You For Adding The Bot To Your Server If You Need Any Help In The Bot Go To Suuport Server** https://discord.gg/RDCsYdN`)
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/RDCsYdN**")
